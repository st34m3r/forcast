...
#to save scaler as it is in a file (dump)
scaler_filename = "scaler.pkl"
file = open(scaler_filename, 'wb')
...
for i in range(60,len(train_data)):
    x_train.append(train_data[i-60:i,0])# 0,59 -->1,60-->2,61 .... len-60 , len-1
    y_train.append(train_data[i,0])     # 60     ,   61 ,    62  ,       len
...
for i in range(60,len(test_data)):
    x_test.append(test_data[i-60:i,0]) # 0->59 // 1->60  // ....// len-1-60-->len-1
